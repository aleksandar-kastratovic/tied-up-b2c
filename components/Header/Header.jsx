...
const Header = ({ categories }) => {
  const categoriesMainLeft = [
    { name: "Početna", slug: "/", isCategory: false, id: 0 },
    { name: "Muškarci", slug: "/muskarci", isCategory: false },
    { name: "Žene", slug: "/zene", isCategory: false },
    { name: "Deca", slug: "/deca", isCategory: false },
  ];
  ...
  return (
    <>
      ...
      >
        <HeaderTop />
        <div className="py-3 px-[3rem] flex items-center justify-center md:justify-between">
          <div className="flex items-center gap-[2.2rem] flex-grow justify-end md:justify-start md:mr-[2rem] ml-[15vw]">
            {categoriesMainLeft.map((category, index) => (
              <Link
                href={`${category.slug}`}
                key={index}
          ...
          <div className="flex items-center gap-[2.2rem] flex-grow justify-start md:justify-end md:ml-[2rem] hidden md:flex mr-[10vw]">
